...
(function(){
  ...
  var dict = {
    zh: {
      ...
      private_link: '私有',
      private_title: '私有空间',
      private_404: '此页面需要令牌访问。',
      private_enter: '进入',
      private_empty: '暂无私有笔记。',
      private_noconfig: '请先在 assets/config.js 中配置 privateRepo。',
      private_back: '返回',
      notfound_text: '页面不存在。',
      owner_link: '站长入口',
      ...
      post_draft: '这篇文章尚未发布。',
      f_status: '状态（决定内容存放的仓库）',
      status_draft: '草稿（私有仓库，不显示）',
      status_private: '私有（私有仓库，仅你能看）',
      status_public: '公开（发布到博客）',
      status_hint: '草稿与私有存放在私有仓库 ylzh-private，公开后才进入 ylzh；保存时文件自动在两个仓库间移动。',
      need_repo: '请先在写作页「站点设置」中填写公开仓库名。',
      need_priv_repo: '请先在写作页「站点设置」中填写私有仓库名。',
      settings_title: '站点设置',
      settings_title_hint: '仅保存在本浏览器（localStorage），不会上传',
      cfg_owner: 'GitHub 用户名',
      cfg_repo: '公开仓库名',
      cfg_priv: '私有仓库名',
      cfg_editorkey: '写作口令（可选）',
      cfg_save: '保存设置',
      cfg_save_short: '保存',
      cfg_saved: '已保存。',
      s_owner_fetch: '从令牌获取用户名',
      s_repos_fetch: '获取我的仓库',
      s_fetched: '已填入。',
      s_fetched_repos: '已获取 {n} 个仓库，输入时自动提示。',
      s_fetch_fail: '获取失败：请先填写有效的令牌。',
      f_existing: '编辑已有文章',
      f_new: '（新文章）',
      f_title: '标题',
      f_title_en: '英文标题（可选）',
    ...
    en: {
      ...
      private_title: 'Private Space',
      private_404: 'This page requires a token.',
      private_enter: 'Enter',
      private_empty: 'No private notes yet.',
      private_noconfig: 'Set privateRepo in assets/config.js first.',
      private_back: 'Back',
      ...
      f_status: 'Status (decides the storage repo)',
      status_draft: 'Draft (private repo, hidden)',
      status_private: 'Private (private repo, only you)',
      status_public: 'Public (publish to blog)',
      status_hint: 'Drafts and private posts live in the private repo; publishing moves them to the public repo automatically.',
      need_repo: 'Set the public repo name in the editor Settings first.',
      need_priv_repo: 'Set the private repo name in the editor Settings first.',
      settings_title: 'Site settings',
      settings_title_hint: 'Stored only in this browser (localStorage), never uploaded',
      cfg_owner: 'GitHub username',
      cfg_repo: 'Public repo name',
      cfg_priv: 'Private repo name',
      cfg_editorkey: 'Editor passphrase (optional)',
      cfg_save: 'Save settings',
      cfg_save_short: 'Save',
      cfg_saved: 'Saved.',
      s_owner_fetch: 'Get username from token',
      s_repos_fetch: 'Fetch my repos',
      s_fetched: 'Filled.',
      s_fetched_repos: '{n} repos fetched — suggestions while typing.',
      s_fetch_fail: 'Fetch failed: enter a valid token first.',
      ...
      tb_xymatrix: 'Commutative diagram (xymatrix)',
