...
(function(){
  ...
  var dict = {
    zh: {
      ...
      need_repo: '请先在 assets/config.js 中配置 repo。',
      need_priv_repo: '请先在 assets/config.js 中配置 privateRepo。',
      f_existing: '编辑已有文章',
      f_new: '（新文章）',
      f_title: '标题',
      f_title_en: '英文标题（可选）',
    ...
    en: {
      ...
      need_repo: 'Set repo in assets/config.js first.',
      need_priv_repo: 'Set privateRepo in assets/config.js first.',
