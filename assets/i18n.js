...
(function(){
  ...
  var dict = {
    zh: {
      ...
      token_help: '需要仓库 contents 读写权限。创建：GitHub → Settings → Developer settings → Personal access tokens',
      f_existing: '编辑已有文章',
      f_new: '（新文章）',
      f_title: '标题',
      f_title_en: '英文标题（可选）',
    ...
    en: {
      ...
      token_help: 'Needs contents read/write on the repo. Create: GitHub → Settings → Developer settings → Personal access tokens',
